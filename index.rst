...
*  `"Базу данных"`_ в которой вы сможете найти основную информацию об устройстве и применении беспилотных летательных аппаратов, данную информацию можно использовать не только для самостоятельного обучения, но и для проведения учебных занятий по тематике БПЛА.
