...
""""""""""""""""
    ...
    Первой блок в разделе - число-константа.
...
.. attention:: Если вы используете блок "Сделать фото" из раздела "Прочее", нужно также запустить ноду camera_launch
...
Как запустить ноду camera_launch
"""""""""""""""""""""""""""""""""
Для запуска ноды нужно воспользоваться `Web-терминалом`_ или `SSH`_.
