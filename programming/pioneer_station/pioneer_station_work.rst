...
В центральной части окна располагаются окна: :doc:`pioneer_station_code_editor` и :doc:`../../settings/autopilot_parameters`, работа с ними подробно описана в соответствующих разделах.
