...
Основное окно **Pioneer station** представлено редактором кода. В данном окне Вы можете вести разработку программного кода полетного задания "Пионер"а на языке Lua.
