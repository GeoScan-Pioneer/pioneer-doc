...
В правом нижнем углу Pioneer Station выберите вариант подключения "По кабелю USB". В окне программы должы появиться текущие параметры "Пионер"а, углы наклона, напряжение питания и номер. 
