...
**При подключении "Пионера Мини" к Pioneer Station выдает ошибку **Оборудование несовместимо с НСУ** ** - для исправления ошибки следуйте `инструцкии здесь.`_

.. _инструцкии здесь.: mini-nsu.rst
