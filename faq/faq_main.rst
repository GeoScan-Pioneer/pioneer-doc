...
**При подключении "Пионера Мини" к Pioneer Station выдает ошибку "Оборудование несовместимо с НСУ"** - для исправления ошибки следуйте инструкции: :doc:`/faq/mini_nsu`

**При подключении "Пионера Мини" к Geoscan Jump выдает ошибку "Проверьте параметр uMax = 3 connect in progress"** - для исправления ошибки следуйте инструкции: :doc:`/pioneer-mini/settings/firmware_upgrade`
