...
Подключите Пионер к Pioneer Station и активируйте кнопку OPT в `параметрах автопилота`_, чтобы использовать модуль при полёте. 
...
.. _`параметрах автопилота`: autopilot_parameters.html
