...
-  **Inrunner.** Двигатель имеет расположенные по внутренней поверхности
   корпуса обмотки, и вращающийся внутри магнитный ротор.

-  **Outrunner**. Двигатель имеет неподвижные обмотки (внутри) вокруг
   которых вращается корпус с помещенным на его внутреннюю стенку
   постоянными магнитами (статор).

|image10|

Рисунок 11 - Устройство бесколлекторного двигателя
