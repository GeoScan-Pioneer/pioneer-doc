...
При замене двигателей на более мощные вам может понадобиться настройка PID коэффициентов. Неправильные PID  - причина заметных вибраций и колебаний коптера в полёте. 
...
Пионер поддерживает автоматическую проверку двигателей при подготовке к взлёту. За неё отвечают параметры:

* Copter_motorCheckTime - время проверки в секундах на скорость оборотов двигателей на старте. Для отключения проверки установите значение параметра 0 
