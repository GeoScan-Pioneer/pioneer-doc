...
.. note:: Для оценки допустимых оборотов, 'запишите логи'_ полёта в ручном режиме управления и просмотрите данные канала RawAccelGyroData. Подробнее в разделе :doc:`logs`
