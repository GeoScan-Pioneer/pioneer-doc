...
Если с управлением в игре при помощи гироскопа всё более менее понятно, то вот с созданием границ у матрицы всё сложнее. Ведь "сборщик" при максимальном смещении 
должен упираться в стенку, а не перходить на следующий ряд матрицы.
