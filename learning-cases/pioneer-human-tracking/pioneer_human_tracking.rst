...
существует специальных файл, хранящий названия нужных библиотек –
...
5. Для завершения работы программы нажимайте кнопку l до начала процесса посадки, после чего нажмите q.