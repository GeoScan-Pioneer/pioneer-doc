...
Подробно о настройке и программировании камеры - на `странице OpenMV`_

.. _`странице OpenMV`: http://docs.openmv.io/
...
Используя Pioneer Station и OpenMV IDE, загрузите соответствующие программы (:doc:`/pioneer_station/pioneer_station_upload`) на квадрокоптер и модуль камеры. Подключите аккумулятор к "Пионеру" и запустите выполнение программы. Протестируйте ее работу, направляя камеру на объекты с различной яркостью.
