...
.. note:: Настройка работы модулей выполняется с помощью  :doc:`/pioneer_station/pioneer_station_main` перед полетом.
