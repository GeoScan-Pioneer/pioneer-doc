...
6. В следующем окне нажмите **"Встроенный"** или **"Из файла"** и найдите файл с примерным названием **pioneer_mini_V1_1-boot-pioneer-1.6.72**.bin** Самое главное чтобы в названии файла было прописано *pioneer_mini* и версия прошивки *1.6.7011* или старше.

:download:`Актуальная прошивка автопилота 1.6.7257 <pioneer-mini_mini-v10-boot_gs_dev-1.6.7257-bbf20830e.bin>`
