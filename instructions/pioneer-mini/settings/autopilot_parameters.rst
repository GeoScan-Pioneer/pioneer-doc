...
8) После обновления параметров, при нестабильном полете, настоятельно рекомендуется заново откалибровать акселерометр. Для этого в верхнем левом углу нажмите "калибровка", затем "калибровка акселерометра".
