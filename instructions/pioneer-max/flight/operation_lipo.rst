...
.. attention::
	При экспулатации используйте только штатные АКБ для "Пионера Макс"! Использование АКБ с другими электрическими характеристиками может привести к выходу оборудования из строя! 
